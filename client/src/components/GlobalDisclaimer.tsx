...
export default function GlobalDisclaimer() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#0a0d12]/95 backdrop-blur-sm border-t border-red-500/20">
      <p
        className="text-center text-red-400/90 text-xs py-2 px-4 tracking-wide"
